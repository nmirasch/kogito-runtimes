...
public class ProcessSvgResource {
    ...
    public Response getProcessSvg(@PathVariable("processId") String processId) {
    ...
    public Response getExecutionPathByProcessInstanceId(@PathVariable("processId") String processId,
